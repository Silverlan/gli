/// @brief Definition of get_format_info. Moved here to avoid C1605 compiler error with msvc.
/// @file gli/format.cpp
...
gli::detail::formatInfo const & gli::detail::get_format_info(format Format)
{
